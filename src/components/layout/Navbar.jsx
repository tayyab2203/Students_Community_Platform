      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {isMobileMenuOpen && (
  <div
    className="lg:hidden fixed top-20 left-0 w-full bg-white/95 backdrop-blur-md z-40 shadow-xl border-t border-gray-200 animate-slideDown"
    onClick={() => setIsMobileMenuOpen(false)} // ✅ Click anywhere closes menu
  >
    <div className="flex flex-col space-y-2 p-4">
      {navItems.map((item) => (
        <button
          key={item.name}
          onClick={(e) => {
            e.stopPropagation(); // prevent closing before navigation
